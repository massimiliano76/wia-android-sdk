...
/** package */ class ManifestInfo {
  private static final String TAG = "io.wia.ManifestInfo";
  ...
  //       WLog.v(TAG, "Using " + pushType + " for push.");
  //     }
  //   }
  //   return pushType;
  // }
  ...
  //   // if (!WiaPushBroadcastReceiver.isSupported()) {
  ...
  //         if (message != null) WLog.e(TAG, message);
  //         break;
  //       case MISSING_OPTIONAL_DECLARATIONS: // Using anyway.
  //         if (message != null) WLog.w(TAG, message);
  //         return type;
  //       case SUPPORTED:
  //         return type;
  //     }
  ...
  private static Context getContext() {
    return Wia.getApplicationContext();
  }
